...
<TABLE border=10 cellSpacing=0 cellPadding=0 width="100%" bgColor=#
4e9258>
<TR>
...
String sid=request.ge
tParameter("StudentID");
...
if(!rs.next()){
out.println("<TABLE border=0 cellSpa
cing=10 cellPadding=0 width=100% bgColor=#54c571> <tr><td
width=30% align=left>");
...
* from "+tbl+" where SID="+sid+" and Sname='"+sname+"'");
if(!rs1.next()){
out.println("<TABLE border=0 cellSpacing=10 cellPadding=0 width=100% bgColor=#54c571> <tr><td
width=30% align=left>");
out.println("<img src=fail.gif width=200 height=15
0></td><td align=left>");
out.println("<h3>Invalid Account</h3></td></tr>");
out.println("<tr><td>&nbsp;</td></tr><tr><td>&nbsp;</td></tr><tr><td>&nbsp;</td></tr>");
out.println("<tr><td align=left><font size=4><a href='slogin.html'>Back</a></
font></td></tr>");
}
else
{
